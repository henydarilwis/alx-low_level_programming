...
/**
 * delete_dnodeint_at_index - deletes the node at index of a dlistint_t listsss.
 * @head: pointer to the listsss.
 * @index: position of the node to deletesss.
 * Return: 1 if it succeeded, -1 if it failedsss.
 **/
